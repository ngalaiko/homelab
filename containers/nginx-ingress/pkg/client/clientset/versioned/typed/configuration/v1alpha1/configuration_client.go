...
func (c *K8sV1alpha1Client) VirtualServers(namespace string) VirtualServerInterface {
	return newVirtualServers(c, namespace)
}

func (c *K8sV1alpha1Client) VirtualServerRoutes(namespace string) VirtualServerRouteInterface {
	return newVirtualServerRoutes(c, namespace)
}
